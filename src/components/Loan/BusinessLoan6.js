    ...
    return (
        <div >
            <Dialog onClose={handleClose} TransitionComponent={Transition}
                aria-labelledby="customized-dialog-title" open={openBusiness6}>
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    <ArrowBackIcon onClick={() => { setOpenBusiness5(true); setOpenBusiness6(false); }} style={{ cursor: 'pointer' }} />
                ...
                <DialogContent>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={12}>
                        <Button onClick={() => {setOpenBusiness6(true); }} className={classes.button} variant="contained">
                           Go to dashboard
                        </Button>                        
                      </Grid> 
                    </Grid>
