    ...
    return (
        <div >
            <Dialog onClose={handleClose} TransitionComponent={Transition}
                aria-labelledby="customized-dialog-title" open={openPersonal4}>
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    <ArrowBackIcon onClick={() => { setOpenPersonal3(true); setOpenPersonal4(false); }} style={{ cursor: 'pointer' }} />
                ...
                <DialogContent>
                    ...
                    <Grid item xs={12} sm={12}>
                        ...
                        <Grid item xs={12} sm={12}>
                        <Button onClick={() => {setOpenPersonal4(false); setOpenPersonal5(true)}} className={classes.button} variant="contained">
                           Confirm
                        </Button>                        
                      </Grid> 
                    </Grid>
