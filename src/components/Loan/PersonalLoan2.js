    ...
    return (
        <div >
            <Dialog onClose={handleClose} TransitionComponent={Transition}
                aria-labelledby="customized-dialog-title" open={openPersonal2}>
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    <ArrowBackIcon onClick={() => { setOpenPersonal1(true); setOpenPersonal2(false); }} style={{ cursor: 'pointer' }} />
                ...
                <DialogContent>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={12}>
                        <Button onClick={() => {setOpenPersonal2(false); setOpenPersonal3(true)}} className={classes.button} variant="contained">
                           Next
                        </Button>                        
                      </Grid>
                    </Grid>
