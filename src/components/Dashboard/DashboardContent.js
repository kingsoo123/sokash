...
export default function DashboardContent() {
  ...
  const [showLoanPersonal1, setShowLoanPersonal1] = useGlobalState('Personal1Open');
  const [showLoanPersonal2, setShowLoanPersonal2] = useGlobalState('Personal2Open');
  const [showLoanPersonal3, setShowLoanPersonal3] = useGlobalState('Personal3Open');
  const [showLoanPersonal4, setShowLoanPersonal4] = useGlobalState('Personal4Open');
  const [showLoanPersonal5, setShowLoanPersonal5] = useGlobalState('Personal5Open');

  const [showLoanBusiness1, setShowLoanBusiness1] = useGlobalState('Business1Open');
  const [showLoanBusiness2, setShowLoanBusiness2] = useGlobalState('Business2Open');
  const [showLoanBusiness3, setShowLoanBusiness3] = useGlobalState('Business3Open');
  const [showLoanBusiness4, setShowLoanBusiness4] = useGlobalState('Business4Open');
  const [showLoanBusiness5, setShowLoanBusiness5] = useGlobalState('Business5Open');
  const [showLoanBusiness6, setShowLoanBusiness6] = useGlobalState('Business6Open');

  const [showPayback, setShowPayback] = useGlobalState('Payback');
  const [showPaybackPayment, setShowPaybackPayment] = useGlobalState('PaybackPayment');
  const [showPaymentConfirmation, setShowPaymentConfirmation] = useGlobalState('PaymentConfirmation');
  return (
    <div className={classes.root}>
      <Grid container spacing={1}>
        ...
        <Grid container spacing={1}>
            ...
            <Typography className={classes.wallet} variant="h4" gutterBottom>
               Wallet Balance
            </Typography>
            ...
            <Grid item xs={12} sm={6}>
            <Paper className={classes.paper}>
            <Typography style={{cursor: 'pointer'}} onClick={() => setShowLoan(true)} variant="h4" gutterBottom>
            <img style={{marginTop: 0}} src={Getloan} height="120px" width="120px"></img>
            <br></br>
            TAKE A LOAN
            </Typography>
            </Paper>
            ...
            <Grid item xs={12} sm={6}>
            <Paper className={classes.paper}>
            <Typography style={{cursor: 'pointer'}} onClick={() => setShowPayback(true)} variant="h4" gutterBottom>
            <img style={{marginTop: 0}} src={Payloan} height="120px" width="120px"></img>
            <br></br>
               PAYBACK
            </Typography>
            </Paper>
        ...
        <Grid item xs={12} sm={6}>
          <div style={{margin: 0}}>
         <img style={{marginTop: 0}} src={PlayStore} height="50px" width="200px"></img>
         <img style={{marginTop: 0}} src={Appstore} height="50px" width="200px"></img>
         </div>
        <Paper className={classes.paper}>
